...
public class OrderInitData {
    ...
    public void init() {
        ...
        // 메뉴 등록
        Menu americano = menuRepository.save(new Menu("아메리카노", "아메리카노 입니다", 3000, 5, "커피", IMAGE_URL, IMAGE_NAME));
        Menu latte = menuRepository.save(new Menu("카페라떼", "카페라떼입니다", 4000, 5, "커피", IMAGE_URL, IMAGE_NAME));
